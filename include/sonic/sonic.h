...
#define SONIC_STRS_IMPL(s) #s
#define SONIC_STRS(s) SONIC_STRS_IMPL(s)
#define SONIC_VERSION_STRING      \
  SONIC_STRS(SONIC_MAJOR_VERSION) \
  "." SONIC_STRS(SONIC_MINOR_VERSION) "." SONIC_STRS(SONIC_PATCH_VERSION)
